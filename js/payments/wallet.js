...
function parseFullWalletType(idToCollapse,monthTotal, monthName, historyTotal,htmlDetailGenerator){
	...
	return'<div class="row players-list-item vertical-align color-player-list2 even"> <div class="col-xs-1 col-sm-1"><!--i class="fa fa-question-circle-o" aria-hidden="true" style="font-size: 18px;"></i--></div><div class="col-xs-6 col-sm-6 text-block-style1">Total '+monthName+'</div><div class="col-xs-5 col-sm-5"> <p class="text-right nomarging"> <span class="text-block-style2">'+monthTotal+' <img src="img/icons/coins/coins.png" style="margin-right: 0px;margin-top: -5px;margin-bottom: -3px;margin-left: 5px;width: 20px;"></p></div></div><div class="row players-list-item vertical-align color-player-list2 odd"> <div class="col-xs-1 col-sm-1"><!--i class="fa fa-question-circle-o" aria-hidden="true" style="font-size: 18px;"></i--></div><div class="col-xs-6 col-sm-6 text-block-style1">Total Historico</div><div class="col-xs-5 col-sm-5"> <p class="text-right nomarging"> <span class="text-block-style2">'+historyTotal+' <img src="img/icons/coins/coins.png" style="margin-right: 0px;margin-top: -5px;margin-bottom: -3px;margin-left: 5px;width: 20px;"></p></div></div><div class="row players-list-item vertical-align color-player-list2 even"> <div class="col-xs-1 col-sm-1"></div><div class="col-xs-6 col-sm-6 text-block-style1">Ver Detalle</div><div class="col-xs-3"></div><div class="col-xs-2 col-sm-2 text-right"> <button type="button" onclick="changeArrow(this);" class="btn btn-live" data-toggle="collapse" data-target="#'+idToCollapse+'"><i class="fa fa-chevron-down" aria-hidden="true"></i></button> </div></div><div id="'+idToCollapse+'" class="collapse">'+htmlDetail+'</div>';
}
function parseDetailMovement(idToCollapse,htmlDetailGenerator){
	...
	if(htmlDetailGenerator.length==0){html='Sin detalles'}else{
		for(i in htmlDetailGenerator){
			...
			html+='<div class="row players-list-item vertical-align color-player-list3 '+oddOrEven+'"> <div class="col-xs-6 col-sm-6 player-name"><p>'+htmlDetailGenerator[i].detail+'</p></div><div class="col-xs-2 col-sm-2 text-right nopadding"> '+dateFormatViewDay(htmlDetailGenerator[i].date)+' </div><div class="col-xs-4 col-sm-4"> <p class="text-right nomarging"> <span class="text-block-style1">'+htmlDetailGenerator[i].coins+' <img src="img/icons/coins/coins.png" style="margin-right: 0px;margin-top: -5px;margin-bottom: -3px;margin-left: 5px;width: 15px;"></p></div></div>';
		}
	}
