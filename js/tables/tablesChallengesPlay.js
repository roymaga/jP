...
function readOpenChallenge(openTable){
		...
		var titleSelectedForTable=openTable.group.name;
...
function contentForOpenChallengeWindow(shownTable){
	var first= '<div class="container container-full "> <div class="container container-title bg-color2 text-color2" onClick="openTableDfInformation(\''+shownTable.id+'\',\'challenge\');"> <div class="row"> <div class="col-xs-2 chpadding"> <h3><i class="fa fa-info-circle" aria-hidden="true"></i></h3></div><div class="col-xs-7 details chpadding"> <h3>'+parseTableChallengeMatchName(shownTable.title)+'</br>'+dateFormatViewNormal(shownTable.start_time)+' </h3></div><div class="col-xs-3 nopadding text-center"> <h3>'+shownTable.amount_of_users_playing+' <i class="fa fa fa-users" aria-hidden="true"></i></h3> <p style="margin-top: -10px;" class="trn">Anotados</p></div></div></div><div class="container match-data"> <div class="row vertical-align"> <div class="col-xs-3 text-center match-cup"><img src="img/tournament/flags/flag-'+shownTable.tournament_id+'.jpg"></div><div class="col-xs-3 text-center match-type"><a onClick="openTableInformation(\''+shownTable.id+'\',\'challenge\');">'+costOfTable(shownTable)+'</a></div><div class="col-xs-2 text-center prize-type"><a onClick="openTablePrizeInformation(\''+shownTable.id+'\',\'challenge\' );">'+earnsOfTable(shownTable)+'</a></div><div class="col-xs-4 text-right match-button">'+buttonOfChallengeTable(shownTable.id,shownTable.playing)+'</div></div></div><div class="container container-title bg-color11 text-color2"> <div class="col-xs-9 chpadding"> <p style=" margin: 0px;" class="trn">Grupo</p><h3 style=" margin-top: 0px; font-size: 1.7em;">'+shownTable.group.name+'</h3></div><div class="col-xs-3 chpadding text-right"> <p style=" margin: 0px;" class="trn">Invitados</p><h3 style=" margin-top: 0px;">'+shownTable.group.users.length+' <i class="fa fa-reply-all" aria-hidden="true"></i></h3></div></div><div class="container list-style2 text-color1 bg-color5"> <div class="row vertical-align"> <div class="col-xs-8 text-left match-cup chpadding"> <h4 style=" margin: 7px;" onClick="explanationChallenge(\'pozo_estimado\');"><span class="trn">Pozo estimado</span> <i class="fa fa-question-circle" aria-hidden="true"></i></h4></div><div class="col-xs-4 text-center prize-type"> <span style=" font-size: 18px;">'+earnsOfTable(shownTable)+'</span></div></div><div class="row vertical-align"> <div class="col-xs-8 text-left match-cup chpadding" onClick="explanationChallenge(\'pozo_actual\');"> <h4 style=" margin: 7px;"><span class="trn">Pozo actual</span> <i class="fa fa-question-circle" aria-hidden="true"></i></h4></div><div class="col-xs-4 text-center prize-type"> <span style=" font-size: 18px;">'+earnsOfTableNow(shownTable)+'</span></div></div><div class="row vertical-align"> <div class="col-xs-8 text-left match-cup chpadding" onClick="explanationChallenge(\'anotados\');"> <h4 style=" margin: 7px;"><span class="trn">Anotados</span> <i class="fa fa-question-circle" aria-hidden="true"></i></h4></div><div class="col-xs-4 text-center prize-type"> <p style=" font-size: 18px;">'+shownTable.amount_of_users_playing+'</p><i class="fa fa fa-users fa-2x" aria-hidden="true" style=" margin-left: 5px; margin-right: -18px;"></i></div></div><div class="row vertical-align"> <div class="col-xs-8 text-left match-cup chpadding" onClick="explanationChallenge(\'invitados\');"> <h4 style=" margin: 7px;"><span class="trn">Invitados</span> <i class="fa fa-question-circle" aria-hidden="true"></i></h4></div><div class="col-xs-4 text-center prize-type"> <p style=" font-size: 18px;">'+shownTable.group.users.length+'</p><i class="fa fa-reply-all fa-2x" aria-hidden="true" style=" margin-left: 5px; margin-right: -18px;"></i></div></div></div><div class="container title-box bg-color3" id="action-bar"> <div class="row vertical-align"> <div class="col-xs-12"> <div id=""> <h1 class="trn">Participantes</h1> <p style="font-size:0.8em; color:#EEE;"><span class="trn">Estos son los participantes del grupo</span> "'+shownTable.group.name+'"</p></div></div></div></div><div class="row-fluid vertical-align friend-item" onclick="addUsersToChallengeGroupByLink(\''+shownTable.group.invitation_token+'\');" style=" background: rgba(0, 128, 0, 0.11);"> <div class="col-xs-3"><span class="fa-stack fa-2x friend-picture"><i class="fa fa-circle fa-stack-2x" style="color: #35b44a;"></i><i class="fa fa-user-plus fa-stack-1x fa-inverse"></i></span></div><div class="col-xs-9"> <h3 class="friend-nick" style=" color: #35b44a;"><span class="trn">Añadir participantes</span> +</h3> <p class="friend-name trn">Agrega gente al grupo</p></div></div>';
	var users=addUsersToChallengeGroup (shownTable);
	var last='<div class="row-fluid vertical-align friend-item" onclick="exitActualGroup(\''+shownTable.group.id+'\');" style=" background: rgba(244, 67, 54, 0.11);"> <div class="col-xs-3"><span class="fa-stack fa-2x friend-picture"><i class="fa fa-circle fa-stack-2x" style="color: #F44336;"></i><i class="fa fa-user-times fa-stack-1x fa-inverse"></i></span></div><div class="col-xs-9"> <h3 class="friend-nick" style=" color: #f44336;"><span class="trn">Salir del grupo</span> -</h3> <p class="friend-name trn">No quiero pertenecer mas a este grupo</p></div></div></div>' ;
...
function explanationChallenge(which){
	switch(which) {
    case 'pozo_estimado':
		avisoEmergenteJugaPlay("<span class='trn'>Pozo estimado</span>","<p class='trn'>Es el pozo que se generaría si juegan todos los usuarios invitados al desafío.</p>");
        break;
    case 'pozo_actual':
        avisoEmergenteJugaPlay("<span class='trn'>Pozo actual</span>","<p class='trn'>Es el pozo que se acumuló gracias a los usuarios que ya hicieron su jugada, los anotados. Este va a ir creciendo a medida que los usuarios jueguen el desafío.</p>");
        break;
	case 'anotados':
        avisoEmergenteJugaPlay("<span class='trn'>Anotados</span>","<p class='trn'>Son los usuarios que ya realizaron su jugada. Y pusieron sus monedas en el pozo.</p>");
        break;
    case 'invitados':
        avisoEmergenteJugaPlay("<span class='trn'>Invitados</span>","<p class='trn'>Son los usuarios que componen el grupo. Que están invitados a jugar el desafío.</p>");
        break;
	case 'copiar_codigo':
        avisoEmergenteJugaPlay("<span class='trn'>Usar códigos</span>","<p class='trn'>1. Copiar el código y enviar a amigos que quieras invitar al desafío.</p><p class='trn'>2. Tus amigos tienen que ingresar el código en el sector desafíos.</p><p class='trn'>3. ¡Listo! Podrás desafiar a tus amigos.</p>");
        break;
    default:
        ;
	}
...
function parseUserForChallengeFriend(user,hadPlayed,left){
	var previousContactsLoad=JSON.parse(getCookie("contactsToSync-Jp")).contacts;
	for (friend in previousContactsLoad){
	...
	return parseUserForChallengeNotFriend(user,hadPlayed,left);// No deberia llegar pero por las dudas lo agrego
}
...
function parseUserForChallengeNotFriend(user,hadPlayed){
	return '<div class="row-fluid vertical-align friend-item" onclick="selectUserForAddingToGroupOfFriends(this,\''+user.nickname+'\',\''+user.email+'\');"> <div class="col-xs-3">'+parseUserForChallengeNotFriendImage(user.image)+'</div><div class="col-xs-6"> <h3 class="friend-nick">'+user.nickname+'</h3> <p class="friend-name trn">Agregar a amigos +</p></div><div class="col-xs-3 nopadding"> '+parseButtonPlayedForChallenge(hadPlayed)+' </div></div>';
}
...
function parseButtonPlayedForChallenge(hadPlayed){
	if(hadPlayed>-1){return '<button type="button" class="btn btn-default btn-style2 trn" style=" background: rgba(139, 195, 74, 0.11); color: #4CAF50; border: 1px solid #4CAF50; padding: 5px 5px;">Anotado</button>';}
	else{ return '<button type="button" class="btn btn-default btn-style2 trn" style=" background: rgba(110, 111, 113, 0.06); color: black; padding: 5px 5px;">Pendiente</button>';}
}
function selectUserForAddingToGroupOfFriends(element,nickname,email){
	...
	BootstrapDialog.show({
			 ...
			 title: "<H1 class='trn'>Agregar como amigo</H1>",
            message: '<p class="trn">Agregar como amigo eligiendo un Nombre o Apodo con el que reconocer a este usuario de ahora en adelante.</p><p><fieldset class="form-group"><span class="trn">Nombre/Apodo:</span><input type="text" class="form-control trn" data-trn-holder="NombreApodo" id="formChallengeUserNick" placeholder="Nombre/Apodo:"></fieldset></p>',
			buttons: [{
                label: '<span class="trn">Guardar</span>',
                ...
                action: function(dialogItself){
					...
					if(nick.length>1){
						...
						dialogItself.close();
					}else{avisoEmergenteJugaPlay("<span class='trn'>Nombre/Apodo:</span>","<p class='trn'>Ingrese un Nombre o Apodo con el que reconocer a este usuario en un futuro.</p>");};
                }
...
function exitActualGroup(groupId){
	BootstrapDialog.show({
            ...
            message: '<p class="trn">¿Desea salir del grupo?</p><p class="trn">Al salir no podrá ver más detalles del grupo y perderá el privilegio de ver el detalle de los partidos que jugo dentro del mismo.</p>',
			buttons: [{
                ...
                label: ' <span class="trn">Salir</span>',
...
function addUsersToChallengeGroupByLink(shareLink){
	avisoEmergenteJugaPlay("<span class='trn'>Copiar código</span>",'<p onclick="explanationChallenge(\'copiar_codigo\');"> <span class="trn">Invita a usuarios al desafío con este código</span>: <i class="fa fa-question-circle" aria-hidden="true"></i></p><p><input onclick="this.select();" type="text" style=" width: 100%; text-align: center;" value="'+shareLink+'"></p><p><small class="trn">Código valido por 48Hs</small></p>');
}
