...
function bodyOfDetailHistory(historyMatch,playersSel){
	return '<div class="container container-full historial-detalle"><div class="container container-title bg-color2"><h3>'+historyMatch.title+'</h3></div><div class="container head-detalle text-center text-color2 text-uppercase"><div class="row text-center"><div class="col-xs-6 col-sm-6"><h1>...</h1><h5>Mi posición en este partido</h5></div><div class="col-xs-6 col-sm-6"><h1>...</h1><h5>Puntos sumados por Jugadores</h5></div></div></div><div class="container bg-color5 row" style="margin: 0px;padding: 0px;"><a class="btn btn-primary btn-style3 full-width" onClick="openTableInformation(0);"><i class="fa fa-info-circle" aria-hidden="true"></i> Detalle del partido</a></div><div class="container list-style2 text-color2">'+jugadoresElejidosParaElPartido(playersSel)+'</div></div>';
}
function jugadoresElejidosParaElPartido(playersSel){
	contentAgregarPlayer='';
	for(a in playersSel){
	contentAgregarPlayer+='<div class="row vertical-align bg-color5 text-color1"><div class="col-xs-1 col-sm-1" style="padding: 0px; width: 25px; margin-right: 4px;"><img src="'+playerGetImage(playersSel[a].id)+'" class="player-profile-pic small"></div><div class="col-xs-5 col-sm-5" style="padding: 0px;"><p>'+playersSel[a].first_name+' '+playersSel[a].last_name+'</p></div><div class="col-xs-2 col-sm-2" style="padding-right: 0px;"><p> </p></div><div class="col-xs-2 col-sm-2" style="padding: 0px; width: 25px;"><img class="team-logo small" src="'+clubGetLogo(playersSel[a].team_id)+'"></div><div class="col-xs-2 col-sm-2">Esperando</div></div>';
	}
