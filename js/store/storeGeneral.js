// JavaScript Document
window.onload=setTimeout(function(){showPrizesToChengeInStore();}, 1000);
...
function returnPrizeToShow(prize){
	return '<div class="col-xs-6 reward"><img src="'+prize.img+'" class="full-width"><h5>'+prize.title+'</h5> <h4>'+prize.country+'</h4><p class="text-color3">'+prize.price+' <img src="img/icons/coins/coins.png" width="25px"> </p><button class="btn btn-primary btn-style3" onClick="askForPrize('+prize.price+',\''+prize.title+prize.country+'\');" type="submit">Canjear</button></div>'
}
