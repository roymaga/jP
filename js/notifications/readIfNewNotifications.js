...
function parseNotification(notification, oddEven){
	...
	if(notification.type_name=="challenge"){return '<div class="row players-list-item vertical-align color-player-list '+oddOrEven+'"> <div class="col-xs-2 col-sm-2"><i class="fa fa-users fa-2x" aria-hidden="true"></i></div><div class="col-xs-6 col-sm-6 player-name"> <p>'+notification.title+'</p></div><div class="col-xs-4 col-sm-4 text-right"> <button type="button" class="btn btn-default btn-style2" onclick="'+notification.action+'">¡Jugar!</button> </div></div>';}
	if(notification.type_name=="exchange-ready"){return '<div class="row players-list-item vertical-align color-player-list '+oddOrEven+'"> <div class="col-xs-2 col-sm-2"><i class="fa fa-gift fa-2x" aria-hidden="true"></i></div><div class="col-xs-6 col-sm-6 player-name"> <p>'+notification.title+'</p> </div><div class="col-xs-4 col-sm-4 text-right"> <button type="button" class="btn btn-default btn-style2" onclick="'+notification.action+'">Premios</button> </div></div>';}
	if(notification.type_name=="result"){return '<div class="row players-list-item vertical-align color-player-list '+oddOrEven+'"> <div class="col-xs-2 col-sm-2"><i class="fa fa-futbol-o fa-2x" aria-hidden="true"></i></div><div class="col-xs-6 col-sm-6 player-name"> <p>'+notification.title+'</p></div><div class="col-xs-4 col-sm-4 text-right"> <button type="button" class="btn btn-default btn-style2" onclick="'+notification.action+'">Historial</button> </div></div>';}
	if(notification.type_name=="friend-invitation"){return '<div class="row players-list-item vertical-align color-player-list '+oddOrEven+'"> <div class="col-xs-2 col-sm-2"><i class="fa fa-user-plus fa-2x" aria-hidden="true"></i></div><div class="col-xs-6 col-sm-6 player-name"> <p>'+notification.title+'</p></div><div class="col-xs-4 col-sm-4"> <p class="text-right nomarging"> <span class="text-block-style2">'+notification.text+'</span> <img src="img/icons/coins/coins.png" style="margin-right: 0px;margin-top: -5px;margin-bottom: -3px; width: 20px;"></p></div></div>';}
	if(notification.type_name=="new" || notification.type_name=="personal"){return '<div class="row players-list-item vertical-align bg-color2 text-color2"> <div class="col-xs-2 col-sm-2"><i class="fa fa-bell-o fa-2x" aria-hidden="true"></i></div><div class="col-xs-8 col-sm-8 player-name"> <p>'+notification.title+'</p></div><div class="col-xs-2 col-sm-2 text-right"> <button type="button" onclick="changeArrow(this);" class="btn btn-live" data-toggle="collapse" data-target="#'+id+'"><i class="fa fa-chevron-down" aria-hidden="true"></i></button> </div></div><div id="'+id+'" class="collapse"> <div class="row players-list-item vertical-align color-player-list2 even"> <div class="container"> <p>'+notification.text+'</p></div></div></div>';}
}
